  ...
  return (
    <View style={styles.container}>
      {props.isTopplaceHolder === false ? (
        ...
        <View>
          <Text style={styles.topPlaceholderTxt}>{props.topPlaceholder}</Text>
        </View>
      )}
      <View
        style={[
          ...
          {
            justifyContent: props.isCountryCode
              ? 'flex-start'
              : 'space-between',
          },
        ]}>
        {props.isCountryCode && (
          <TouchableOpacity
            ...
            {...props}>
            <Text>{props.countryFlag}</Text>
            <View
              style={{
                paddingHorizontal: 6,
                color: props.countryCodeTxtColor
                  ? props.countryCodeTxtColor
                  : Colors.black,
              }}>
        ...
        <View style={{minWidth: props.isCountryCode ? '46%' : '50%'}}>
          <TextInput
            ...
            style={[
              styles.textInput,
              {color: props.txtColor ? props.txtColor : Colors.secondaryColor},
            ]}
          />
        </View>
        {props.hideButton && (
          <TouchableOpacity activeOpacity={0.6} onPress={() => setHide(!hide)}>
            <Image
        ...
        {props.isEditButton && (
          <TouchableOpacity
            style={{
              ...
              paddingLeft: GlobalStyle.size.width / 22.5,
            }}
            activeOpacity={0.4}
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <TouchableOpacity
                  ...
                  <Text
                    ...
                    {props.isVerifeidMobile
                      ? Strings.profile.verified
                      : Strings.profile.notVerified}
                  </Text>
                </TouchableOpacity>
                <View
                  style={{
            ...
            <Image
              source={
                props.rightIcon
                  ? props.rightIcon
                  : props.isFromEdit
                  ? Assets.profile.disableEditIcon
                  : Assets.profile.editIcon
              }
              style={{
                tintColor: props.isFromEdit
                  ? Colors.quarternary
                  : 'rgba(0,0,0,0.9)',
              }}
            />
      ...
      {props.validationErrorMessageShow && (
