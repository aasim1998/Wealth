...
const PaymentTypeComponent = (props) => {
    ...
    const [isInfoDeadLine, setIsInfoDeadLine] = React.useState(false)
    ...
    const onCloseModal = ()=>{
        setIsInfo(false)
        setIsInfoDeadLine(false)
    }
    const deadLineDateInfo=()=>{
       setIsInfoDeadLine(true)
    }
            ...
            <>
                  ...
                  <View>
                    <View style={styles.groupTitleContainer}>
                        ...
                        <TouchableOpacity style={{paddingHorizontal: 2}} onPress={onPressHandler}>
                            <Image
                                source={isInfo 
                    ...
                    </View>
                    {
                        ...
                        <QMarkInfoModal 
                            ...
                            qMarkInfo={ Strings.createFundGroup.DueDateMarkInfo}
                ...
                {props.isDueDateValid&&<View style={styles.groupDescriptionErrorContainer}>
                            ...
                            {Strings.fieldValidationErrorMessage.dueDateShouldBe}</Text>
                        </View>}
                 ...
                 {/*Deadline period components start*/}
                    ...
                    <View style={styles.groupTitleContainer}>
                        ...
                        onPress={deadLineDateInfo}>
                            <Image
                                source={isInfoDeadLine?Assets.createFundGroup.qMarkColored:Assets.createFundGroup.qMark}
                            />
                    ...
                    </View>
                    {
                        isInfoDeadLine &&
                        <QMarkInfoModal 
                            modalVisible={isInfoDeadLine} 
                            onPressClose={onCloseModal} 
                            qMarkInfo={ Strings.createFundGroup.DeadLineDateMarkInfo}
                            modalPosition={GlobalStyle.size.height / 2.5}/>
                    }
                </View>
