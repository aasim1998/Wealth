        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            {isRequestPayment && (
              <View
                style={[
                  styles.successModelDescriptionContainer,
                  {paddingBottom: 20},
                ]}>
                <View style={styles.currencyfieldContainer}>
                  <CustomTextInput
                    topPlaceholder={
                      Strings.home.howYouNOthersPaying.beneficiaryNameWithStar
                    }
                    ...
                    validationErrorMessage={
                      Strings.fieldValidationErrorMessage.selectCurrency
                    }
            ...
            {isConfirm && (
              <View style={styles.confirmMessageContainer}>
                <Text
                  style={[
                    styles.messageTitle,
                    {marginVertical: GlobalStyle.size.height / 110},
                  ]}>
            ...
            {isConfirm && (
              <View style={styles.selectOptionContainer}>
                ...
                <View style={{flexDirection: 'row'}}>
                  {Strings.home.howYouNOthersPaying.paymentStatusData.map(
                    (item, index) => {
                      return (
                        <TouchableOpacity
                          key={index}
                          style={[
                            styles.onPressPayment,
                            {
                              borderColor:
                              ...
                              styles.statusColor,
                              {
                                backgroundColor:
                                  ...
                                  Strings.home.howYouNOthersPaying
                                    .paymentStatusData[0].title1
                                    ? Colors.bgColor.tertiaryColor
                                    : item.title1 ===
                                      Strings.home.howYouNOthersPaying
                                        .paymentStatusData[1].title1
                          ...
                          <Text
                            style={[styles.selectionTitle, {paddingTop: 0}]}>
                            {item.title2}
                          </Text>
                        </TouchableOpacity>
                      );
            ...
            {(isSetReminder || isRequestPayment) && (
            ...
            <TouchableOpacity
              ...
              <Image source={props.modelButtonIcon} />
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  modalView: {
    ...
    width: GlobalStyle.size.width / 1.1,
    borderRadius: 5,
    padding: 0,
    shadowColor: '#000',
    shadowOffset: {
  ...
  onPressPayment: {
    borderWidth: 1,
    width: GlobalStyle.size.width / 4.6,
