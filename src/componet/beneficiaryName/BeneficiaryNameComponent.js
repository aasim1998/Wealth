...
const BeneficiaryNameComponent = props => {
  ...
  return (
    <View
      style={[
        styles.container,
        {paddingBottom: props.showSetRandom ? 0 : GlobalStyle.size.height / 30},
      ]}>
      ...
      <View style={styles.addGroupMembersOptionsContainer}>
        ...
        {props.beneficiaryData.map((item, index) => {
          return (
            <View key={index} style={styles.beneficiaryNameContainer}>
              <View style={styles.beneficiaryNameNTextInputContainer}>
                ...
                <TouchableOpacity
                  onPress={() =>
                    props.navigation.navigate('ViewProfile', {
                      passFromBeneficiary: {
                        ...
                        mobile_verified:
                          item.mobile_verified == 1 ? true : false,
                      },
                    })
                  }
                  ...
                  {item.userId === props.passCoordinatorUserId && (
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  props.onPressRemoveNonAcceptedInvitationMember(
                    item.is_external,
                    item.mobile,
                    item.userId,
                  )
                ...
                <View
                  style={[
                    styles.groupAcceptenceStatusContainer,
                    {
                      borderColor:
                        item.is_accepted == 2
                          ? Colors.pentaColor
                  ...
                  <Text
                    ...
                    {item.is_accepted == 2
                      ? Strings.home.groupDetails.rejected
                      : item.is_accepted
                      ? Strings.home.groupDetails.accepted
                      : Strings.home.groupDetails.awaiting}
                  </Text>
                </View>
      ...
      {props.showSetRandom && (
        <View style={styles.setAutoRandomOrderContainer}>
          <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  groupAcceptenceStatusContainer: {
    width: GlobalStyle.size.width / 5.3,
    borderRadius: 21,
    borderWidth: 1,
    height: 21,
    justifyContent: 'center',
