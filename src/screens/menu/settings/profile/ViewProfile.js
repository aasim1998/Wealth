...
const ViewProfile = props => {
  const { isFromScreen } = props?.route?.params;
  const [isLoaderVisible, setIsLoaderVisible] = useState(false);
  const [profileData, setProfileData] = useState('');
  const [refreshing, setRefreshing] = useState(false);
  const [isNotification, setIsNotification] = useState(false);
  const mobileVerifiedStatus =
    props?.route?.params?.passFromBeneficiary?.mobile_verified;
  const isFromBeneficiary =
    props?.route?.params?.passFromBeneficiary?.isFromBeneficiary;
  const isCoordinated_by_me =
    props?.route?.params?.passFromBeneficiary?.isCoordinated_by_me;
  const isExternal = props?.route?.params?.passFromBeneficiary?.isExternal;
  const pass_profile_image =
    props?.route?.params?.passFromBeneficiary?.pass_profile_image;
  const pass_first_name =
    props?.route?.params?.passFromBeneficiary?.pass_first_name;
  const pass_last_name =
    props?.route?.params?.passFromBeneficiary?.pass_last_name;
  const pass_email = props?.route?.params?.passFromBeneficiary?.pass_email;
  const pass_short_name =
    props?.route?.params?.passFromBeneficiary?.pass_short_name;
  const pass_mobile = props?.route?.params?.passFromBeneficiary?.pass_mobile;
  const pass_country_id =
    props?.route?.params?.passFromBeneficiary?.pass_country_id;
  const passIsCurrentUser =
    props?.route?.params?.passFromBeneficiary?.passIsCurrentUser;
  const pass_flag = props?.route?.params?.passFromBeneficiary?.pass_flag;
  const passIsMobileVerified =
    props?.route?.params?.passFromBeneficiary?.pass_isMobileVerified;
  const passIsEmailVerified =
    props?.route?.params?.passFromBeneficiary?.pass_isEmailVerified;
  const passPayPalEmail =
    props?.route?.params?.passFromBeneficiary?.passPayPalEmail;
  ...
  const changeMobilMethod = () => {
    props.navigation.navigate('ChangeMobile', {
      viewProfilePassData: { flag: flag, country_id: country_id },
    });
  };
    ...
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        <Header
          onPressLeftIcon={
            isFromBeneficiary
              ? Assets.settings.whiteBackArrow
              : Assets.home.menu
          }
          ...
          headerTitle={
            isFromBeneficiary === undefined || passIsCurrentUser
              ? Strings.profile.myProfile
              : Strings.profile.memberProfile
          }
          {...props}
        />
      </View>
              ...
              <View style={styles.profileImgContainer}>
                <View style={styles.profileImgCircle}>
                  {(profile_image === null || profile_image === undefined) &&
                    (pass_profile_image === null ||
                      pass_profile_image === undefined) ? (
                    <View>
          ...
          <View style={styles.fieldsContainer}>
            ...
            <View style={styles.fieldContainer}>
              <CustomTextInput
                ...
                editable={false}
                validationErrorMessage={Strings.login.pleaseEnterAValidEmail}
                value={paypal_email_id || passPayPalEmail}
              />
            </View>
            <View style={styles.fieldContainer}>
              <CustomTextInput
                ...
                isFromEdit={
                  passIsCurrentUser || isFromBeneficiary == undefined
                    ? false
                    : true
                }
                hideButton={false}
            ...
            <View style={styles.fieldContainer}>
              <CustomTextInput
                ...
                isVerifeidMobile={
                  ...
                  (profileData.mobile_verified == 1 ? true : false)
                }
