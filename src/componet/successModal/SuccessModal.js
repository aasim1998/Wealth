            ...
            <View style={styles.centeredView}>
              <View
                style={[
                  styles.modalView,
                  {
                    paddingTop: props.passIsActivate
                      ? GlobalStyle.size.height / 40
                      : 0,
                    paddingHorizontal: props.passIsActivate
                      ? GlobalStyle.size.width / 17
                      : 0,
                    borderRadius: props.passIsActivate ? 5 : 20,
                    width: props.passIsActivate
                      ? GlobalStyle.size.width / 1.11
                      : GlobalStyle.size.width / 1.23,
                  },
                ]}>
                <View>
                  <Image source={props.modelSuccessIcon} />
                </View>
                <View
                  style={[
                    styles.successTitleContainer,
                    {
                      paddingTop: props.showCancel
                ...
                {props.modelButtonIcon ? (
                    ...
                    {props.passIsActivate && (
                      <View
                        style={[
                          ...
                          {paddingVertical: props.passIsActivate ? 0 : 12},
                        ]}>
                        {props.cancel && (
                          <TouchableOpacity
                  ...
                  <TouchableOpacity
                    ...
                    <Text
                      style={[
                        styles.onPressTxt,
                        {color: props.customButtonTitleColor},
                      ]}>
