...
const HowYouNOthersArePayingComponent = props => {
  ...
  const [currentBeneficiaryUserId, setCurrentBeneficiaryUserId] =
    React.useState('');
  ...
  const paymentData =
    props?.passContributionData[passCurrentSequence - 1]?.paymentData;
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.fieldContainer]}>
        <CustomTextInput
          ...
          placeholder={
            Strings.home.howYouNOthersPaying.enterCurrentPaymentDueBy
          }
          hideButton={false}
          editable={false}
      ...
      <View style={[styles.fieldContainer, {paddingTop: 0}]}>
        <CustomTextInput
          ...
          editable={false}
          validationErrorMessage={Strings.login.firstNameMustNotBeEmpty}
          value={props.passnNxtPaymentDueBy == "Invalid date/Invalid date/Invalid date" ?
          "No Due Date" : props.passnNxtPaymentDueBy
          }
        />
      </View>
      <View
        style={[
          ...
          {paddingTop: 0, marginTop: -GlobalStyle.size.height / 40},
        ]}>
        <CustomTextInput
      ...
      <View
        ...
        <CustomTextInput
          ...
          placeholder={
            props.passTabBarTitle ===
            Strings.home.groupDetails.groupDetailsCategoryData[2].title1
              ? Strings.home.howYouNOthersPaying
                  .enterContributionReceivedFromOthers
      ...
      <View style={styles.contributionMainContainer}>
        <View style={styles.titleContainer}>
          ...
          <Text
            style={[
              styles.contributionNoTitle,
              {paddingRight: GlobalStyle.size.width / 11.5},
            ]}>
          ...
          <Text
            style={[
              styles.contributionNoTitle,
              {paddingRight: GlobalStyle.size.width / 9.5},
            ]}>
            ...
            <TouchableOpacity
              ...
              <View style={[styles.contributionDateStatusContainer]}>
                <Text style={styles.contributionTitle}>
                  {`${index + 1} ${
                    Strings.home.howYouNOthersPaying.contribution
                  }`}
                </Text>
                    ...
                    styles.dateTitle,
                    {
                      ...
                      color:
                        passCurrentSequence == item.sequence
                          ? Utility._compareStringFormtatedDatesWithHyphen(
                              item?.timeline_end_date,
                              Utility._apiParameterDateFormat(new Date()),
                            )
                            ? '#002060'
                            : '#00B050'
                          : passCurrentSequence < item.sequence
                ...
                <View style={styles.plusNMinusContainer}>
                  <Image
                    source={
              ...
              {isOpenDropDown && selectedIndex === index && (
                <View style={[styles.beneficiaryTitleContainer]}>
              ...
              {isOpenDropDown &&
                selectedIndex === index &&
                props?.passContributionData[selectedIndex]?.paymentData.map(
                  (item, index) => {
                    return (
                      <View
                        key={index}
                            ...
                            onPress={() =>
                              props.navigation.navigate('ViewProfile', {
                                passFromBeneficiary: {
                                  ...
                                  passIsCurrentUser:
                                    item.sender.userId ==
                                    props.passCurrentUserId,
                                  isCoordinated_by_me:
                                    props.passIsCoordinated_by_me,
                                  ...
                                  pass_bank_account_name:
                                    item.sender.bank_account_name,
                                  passIsMobileVerified:
                                    item.sender.mobile_verified_at != '',
                                },
                              })
                            }>
                        ...
                        <View
                          ...
                          {props.passTabBarTitle !=
                            Strings.home.groupDetails
                              .groupDetailsCategoryData[0].title1 &&
                            passCurrentSequence >= item.sequence && (
                              <Text
                                style={[
                                  styles.statusTitle,
                          ...
                          {props.passTabBarTitle ==
                          Strings.home.groupDetails.groupDetailsCategoryData[2]
                            .title1 ? (
                              <View
                                style={[
                                  styles.statusColor,
                            ...
                            <TouchableOpacity
                              onPress={()=>props.onPressConfirmSendingPayment(item.sequence)}
                              disabled={
                                !(
                                  (item.payment_status != 'Completed' ||
                                    passCurrentUserId !=
                                      passCurrentBeneficiaryId) &&
                                  passCurrentSequence >= item.sequence &&
                                  item.sender.userId == item.receiver.userId &&
                                  passCurrentUserId !=
                                    passCurrentBeneficiaryId 
                                )
                              }
      ...
      <View
        style={[
          ...
          {
            paddingBottom: GlobalStyle.size.height / 60,
            marginTop:
              props.passTabBarTitle ===
              Strings.home.groupDetails.groupDetailsCategoryData[2].title1
                ? 0
      ...
      <View style={styles.chatButtonContainer}>
        <TouchableOpacity onPress={props.onPressGroupChat}>
          <Image source={Assets.howYouNOthersPaying.groupChat} />
        </TouchableOpacity>
        <TouchableOpacity onPress={props.onPressOneToOneChat}>
          <Image source={Assets.howYouNOthersPaying.oneToOneChat} />
        </TouchableOpacity>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  statusTxtContainer: {
    ...
    width: GlobalStyle.size.width / 6.5,
    borderRadius: 10,
