    ...
    <View style={styles.container}>
      ...
      <View style={styles.paymentStatusColorNTitleMainContainer}>
        <View style={styles.paymentStatusColorNTitleContainer}>
          <View style={styles.statusColor}></View>
        ...
        {/* <View
          style={[
            styles.paymentStatusColorNTitleContainer,
            {paddingRight: GlobalStyle.size.width / 36},
          ]}>
          <View
            style={[
              styles.statusColor,
              {backgroundColor: Colors.textColor.septaColor},
            ]}></View>
          <Text style={styles.paymentTitle}>
      ...
      <View style={styles.paymentStatusColorNTitleMainContainer}>
        {/* <View style={styles.paymentStatusColorNTitleContainer}>
          <View
            style={[
              styles.statusColor,
              {backgroundColor: Colors.bgColor.quarternaryColor},
            ]}></View>
          <Text style={styles.paymentTitle}>
      ...
      <View style={styles.paymentStatusColorNTitleMainContainer}>
        <View style={styles.paymentStatusColorNTitleContainer}>
          <View
            style={[
              styles.statusColor,
              {backgroundColor: Colors.bgColor.pentaColor},
            ]}></View>
          <Text style={styles.paymentTitle}>
...
const styles = StyleSheet.create({
  ...
  lineView: {
    ...
    height: 1,
    width: GlobalStyle.size.width / 1.9,
