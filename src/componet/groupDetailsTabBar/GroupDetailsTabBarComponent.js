...
const GroupDetailsTabBarComponent = (props) => {
    ...
    const [isFromPaymentNotificaton, setPaymentStatus] = useState(props?.isFromPaymentNotificaton)
    ...
    useEffect(() => {
        if (props?.isFromPaymentNotificaton == true) {
            setTitle(Strings.home.groupDetails.groupDetailsCategoryData[1].title1)
        }
    }, [])
                        ...
                        return (
                            <TouchableOpacity
                                ...
                                style={
                                    ...
                                    (isFromPaymentNotificaton == true && Strings.home.groupDetails.groupDetailsCategoryData[1].title1 == item.title1)

                                        ?

                                        [styles.onPressGroupDetails,
                                        {
                                            borderTopWidth: 0,
