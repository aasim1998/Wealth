        ...
        <KeyboardAwareScrollView
          ...
          {isSuccess ? (
            <SuccessScreenComponent
              ...
              successDescription={
                Strings.profile.yourEmailAddressChangedSuccussfully
              }
                  ...
                  <ImageBackground
                    ...
                    <View style={styles.fieldContainer}>
                      <CustomTextInput
                        topPlaceholder={
                          isEnterEmail
                            ? Strings.profile.newEmailAddress
                            : Strings.signup.password
                        }
                        placeholder={
                          isEnterEmail
                            ? Strings.profile.enterNewEmailAddress
                        ...
                        onChangeText={
                          isEnterEmail
                            ? email => setEmail(email.trim())
                            : password => setPassword(password.trim())
                        }
                        value={
                          isEnterEmail ? email : password
                        }
