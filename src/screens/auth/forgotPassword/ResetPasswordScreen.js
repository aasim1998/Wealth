...
import {View, StyleSheet, Text, Platfrom, TouchableOpacity} from 'react-native';
import {
  AppButton,
  CustomTextInput,
  SuccessModal,
    ...
    <View style={styles.container}>
      ...
      <View style={styles.keyboardAwareScroll}>
        <KeyboardAwareScrollView
          ...
          <View
            style={[
              styles.bottomComponentContainer,
            ...
            <View style={styles.confirmTxtInputContainer}>
              <CustomTextInput
                ...
                validationErrorMessage={
                  confirmPassword === ''
                    ? Strings.login.pleaseEnterConfirmPassword
                    : Strings.login.newPasswordNConfirmPasswordSame
                }
            ...
            <View style={styles.cancelButtonContainer}>
              <TouchableOpacity
                ...
                activeOpacity={0.6}>
                <Text style={styles.cancelTitle}>{Strings.otp.cancel}</Text>
              </TouchableOpacity>
            </View>
          </View>
          {isSuccessModalVisible && (
            <SuccessModal
              ...
              succesModelDesciption={
                Strings.sussessModel.youPasswordHasBeenChanged
              }
