    ...
    return(
         <View style={styles.container}>
            ...
            <View style={styles.currencyfieldContainer}>
                <View style={styles.groupTitleContainer}>
                <Text style={styles.groupTitle}>
                    {Strings.createFundGroup.amountToBePaid}
                </Text>
                {props.isFromCreateGroup&&
                <TouchableOpacity 
                     onPress={props.onPressAmountToBePaidQMarkInfo}
                     style={{paddingHorizontal: 2}}>
                    <Image
                        source={props.isAmountToBePaid?Assets.createFundGroup.qMarkColored:Assets.createFundGroup.qMark}
                    />
                </TouchableOpacity>}
             </View>
                <CustomTextInput
                ...
                <View style={styles.startDateEndDateContainer}>
                    ...
                    <View style={styles.fieldContainer}>
                        <CustomTextInput
                            ...
                            value={props.passactivePeriodFinishtDate}
                        />
                    </View>
                </View>
            </View>
